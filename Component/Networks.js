...
import {Text,View,TouchableOpacity,TextInput,ToastAndroid,StyleSheet,Platform,BackHandler} from 'react-native';
import HeaderBar from './common/HeaderBar';
import MySorage from '../api/storage';
import config from '../api/serviceAPI.config';
import {BaseComponent} from './base/BaseComponent';

export default class Networks extends BaseComponent{
    constructor(props){
        super(props)
        this.state={
            network:config.URL
    ...
    render(){ 
        return(<View style={{alignItems:'center'}}>
            <HeaderBar parent={this} name="网络设置" isgoLogin={true}/>    
